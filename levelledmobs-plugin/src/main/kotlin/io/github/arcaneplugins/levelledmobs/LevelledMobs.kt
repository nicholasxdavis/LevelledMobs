...
import io.github.arcaneplugins.levelledmobs.managers.StackManager
...
class LevelledMobs : JavaPlugin() {
    ...
    override fun onEnable() {
        ...
        this.stackManager.load()
        (this.levelInterface as LevelManager).load()
        
        // Start stacking task if enabled
        if (this.stackManager.isStackingEnabled()) {
            this.stackManager.startStackingTask()
        }
